...
public class SauceAndroidNativeApp {
	...
	public SauceAndroidNativeApp(AndroidDriver<WebElement> androidDriver) {
	 ...
	 * hide on click-away.
	 * 
	 * In appium there's no way of doing this with a generalized method for iOS as
	 * of yet.
	 * 
	 */
