//package com.scripted.selfhealingwebstepdefs;
//
...
//import com.scripted.PageObjects.OrangeHRMPage;
...
//import com.scripted.selfHealingPgObj.SAHomePage;
...
//	public static Map<String, String> OrgHRMRow;
...
//		orangeHrmpage = PageFactory.initElements(BrowserDriver.getDriver(), OrangeHRMPage.class);
//		myAppPage = PageFactory.initElements(BrowserDriver.getDriver(), MyAppPage.class);
//		saHmPg = PageFactory.initElements(BrowserDriver.getDriver(), SAHomePage.class);
//		
//		// SFDC Lightening
//	}
//	@Before
...
//		  System.out.println("Testcase name:"+testCaseName.get()) ;
...
//
//		propDriver.setPropFilePath("src/main/resources/Web/properties/Cogmento.properties");
...
//
//		// OrangeHRM
//		propDriver.setPropFilePath("src/main/resources/Web/properties/configOrangehrm.properties");
//		filename = FileUtils.getCurrentDir() + PropertyDriver.readProp("excelName");
//		sheetname = "TC004";
//		key = "";
//		con = new ExcelConnector(filename, sheetname);
//		test = new TestDataFactory();
//		obj = test.GetData(key, con);
//		LinkedHashMap<String, Map<String, String>> getOrgHRMData = obj.getTableData();
//		OrgHRMRow = (getOrgHRMData.get("1"));
//	}
//
//	@After
...
//
//		// OrangeHRM
//		if (strProjname.equalsIgnoreCase("OrangeHRM")) {
//			BrowserDriver.launchWebURL("https://opensource-demo.orangehrmlive.com/");
//			orangeHrmpage.login(OrgHRMRow.get("UserName"), OrgHRMRow.get("Password"));
//		}
//
//		// Network
//		if (strProjname.equalsIgnoreCase("MyApp")) {
//			BrowserDriver.launchWebURL("https://www.rahulshettyacademy.com/AutomationPractice/");
//		}
//
//		// Network
//		if (strProjname.equalsIgnoreCase("StaleApp")) {
//			//http://localhost:9001/StaleApp/
//			BrowserDriver.launchWebURL("https://nunzioweb.com/iframes-example.htm");
//		}
//		
//		if (strProjname.equalsIgnoreCase("Demo")) {
//			//BrowserDriver.launchWebURL("http://localhost:9090/java-tomcat-maven-example");
//			BrowserDriver.launchWebURL("http://localhost:9001/webapps");
//		}
//
//	}
//
...
//
//	/*
//	 * @And("I navigate to {string} page") public void
//	 * i_navigate_to_some_page(String strpageName) throws Throwable { if
//	 * (strpageName.equalsIgnoreCase("SFDCAccounts")) { sfdcHomePage.clckAccnts(); }
//	 * if (strpageName.equalsIgnoreCase("SFDCContacts")) {
//	 * sfdcHomePage.clckCntcts(); } if
//	 * (strpageName.equalsIgnoreCase("SFDCOpportunities")) {
//	 * sfdcHomePage.clckOpprtnts(); } }
//	 * 
//	 * @Then("I should be able to see the {string} created") public void
//	 * i_should_be_able_to_see_account_created(String strMsg) throws
//	 * InterruptedException { if (strMsg.equalsIgnoreCase("SFDCAccount")) {
//	 * Thread.sleep(5000); sfdcHomePage.clckAccnts();
//	 * sfdcAcctsPage.vfyAcctCreatn(fSFDCAcctRow); } if
//	 * (strMsg.equalsIgnoreCase("SFDCContact")) { Thread.sleep(5000);
//	 * sfdcHomePage.clckCntcts(); sfdcCtntsPage.vfyCntctCreatn(fSFDCContRow); } if
//	 * (strMsg.equalsIgnoreCase("SFDCOpportunities")) { Thread.sleep(5000);
//	 * sfdcHomePage.clckOpprtnts(); sfdcOptntsPage.vfyOpptntCreatn(fSFDCOpptRow); }
//	 * if (strMsg.equalsIgnoreCase("SFDCContactactivities")) {
//	 * sfdcCtntsPage.vfyActvtyCrtn(fSFDCContRow); } }
//	 * 
//	 * @When("I enter {string} creation details and click save") public void
//	 * i_enter_creation_details_and_save(String option) throws InterruptedException
//	 * { if (option.equalsIgnoreCase("SFDCAccount")) {
//	 * sfdcAcctsPage.clickNewAccnt(); sfdcAcctsPage.enterAcctInfo(fSFDCAcctRow);
//	 * sfdcAcctsPage.enterAddrInfo(fSFDCAcctRow);
//	 * sfdcAcctsPage.enterAddtnlInfo(fSFDCAcctRow); sfdcAcctsPage.clickSave();
//	 * //Thread.sleep(5000); } if (option.equalsIgnoreCase("SFDCContact")) {
//	 * sfdcCtntsPage.entrNewCntct(); sfdcCtntsPage.enterCntctInfo(fSFDCContRow);
//	 * sfdcCtntsPage.enterAddrInfo(fSFDCContRow);
//	 * sfdcCtntsPage.enterAddtnlInfo(fSFDCContRow); sfdcCtntsPage.clickSave();
//	 * //Thread.sleep(5000); } if (option.equalsIgnoreCase("SFDCOpportunities")) {
//	 * sfdcOptntsPage.clickNewOpptnts(); sfdcOptntsPage.enterAcctInfo(fSFDCOpptRow);
//	 * sfdcOptntsPage.enterAddrInfo(fSFDCOpptRow);
//	 * sfdcOptntsPage.enterDescInfo(fSFDCOpptRow); sfdcOptntsPage.clickSave();
//	 * //Thread.sleep(5000); } }
//	 * 
//	 * @When("I enter activites details and click save") public void
//	 * i_enter_activities_details() { sfdcCtntsPage.clkCntct(fSFDCContRow);
//	 * sfdcCtntsPage.crtNewTsk(fSFDCContRow);
//	 * sfdcCtntsPage.crtNewLogCl(fSFDCContRow);
//	 * sfdcCtntsPage.crtNewEvnt(fSFDCContRow); }
//	 * 
//	 * @Then("I should be able to see the activities listed") public void
//	 * i_should_see_activities_listed() {
//	 * //sfdcCtntsPage.vfyActvtyCrtn(fSFDCContRow); System.out.println("Success"); }
//	 */
//
//	// OrangeHRM apps
//
...
//	public void i_logout_from_cogmento_application() {
...
//	public void i_perform_myapp_control_operations() throws Exception {
...
//	}
//
//	@And("I logout from the MyApp application")
//	public void i_logout_from_myApp_application() {
//		//
//	}
//	
//
//	@And("I click on radio button Radio1")
//	public void i_click_on_redio_button() throws Throwable {
//		saHmPg.clkRdBtn();
//		Thread.sleep(5000);
//	}
//	
...
//	public void i_enter_text_into_suggestion_class() throws Throwable {
//		saHmPg.entSug();
//		Thread.sleep(5000);
//	}
//	
